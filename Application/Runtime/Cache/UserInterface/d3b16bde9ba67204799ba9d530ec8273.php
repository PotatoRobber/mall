				...
				<div class="cont-desc span_1_of_2">
								...
								<td>
									<div class="divhidden">
										<form action="updatecar" method="post">
											<input type="number" value="<?php echo ($p["number"]); ?>" name="number">
											<input type="hidden" name="index" value="<?php echo ($i); ?>">
											<input type="submit" value="确认">
										</form>
									</div>
									<!--<a href="#">修改数量</a>-->
									<a href="delcar?index=<?php echo ($i); ?>">移除商品</a>
								</td>
					...
					<div class="wish-list">
						<ul>
							...
							<li class="compare"><a id="buy" href="order">结算</a></li>
						</ul>
					</div>
   				</div>
...
<script>
    ...
    // updatepara();
    // function updatepara() {
		// var inputnum = document.getElementsByName('number')[0].value;
		// var ahref=document.getElementById('buy');
		// ahref.href="order?inputnum="+inputnum;
    // }
</script>
</html>